    ...
    <div className="relative flex size-full min-h-screen flex-col overflow-x-hidden bg-gray-900 font-sans text-white" style={{ fontFamily: 'Inter, "Noto Sans", sans-serif' }}>
      <div className="flex h-full grow flex-col">
        ...
        <main className="flex flex-1">
          ...
          {/* AI助手侧边栏 */}
          <aside className="w-80 bg-gray-800/50 border-l border-gray-700 sticky top-16 h-[calc(100vh-4rem)] flex flex-col p-4">
            <div className="mb-4">
              <h3 className="text-lg font-semibold text-white flex items-center gap-2">
                <span className="material-symbols-outlined text-[var(--primary-color)]">smart_toy</span>
                AI助手
              </h3>
              <p className="text-sm text-gray-400 mt-1">询问我的项目和技能</p>
            </div>
